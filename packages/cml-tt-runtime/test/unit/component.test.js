...
const cmlPath = resolveTestOutput('index', 'tt')

const {createComponent} = require(cmlPath).default

import * as mock from '../mock/component/options'
...
describe('createComponent', function () {
    describe('transform options', function () {
        ...
        it('should return component.cmlType is "tt"', function () {
          expect(component.cmlType).to.equal('tt');
        })
    })
